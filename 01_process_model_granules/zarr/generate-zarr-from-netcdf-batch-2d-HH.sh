...
# this script converts 2D HH SASSIE-ECCO model netCDF datasets to zarr and pushes them to the cloud.
...
declare -a arr=("SIuice" "SIvice" "ADVxHEFF" "ADVxSNOW" "ADVyHEFF" "ADVySNOW")
