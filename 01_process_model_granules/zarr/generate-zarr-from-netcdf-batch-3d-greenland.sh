...
# this script converts 3D Greenland SASSIE-ECCO model netCDF datasets to zarr and pushes them to the cloud.
...
declare -a arr=("DFrI_SLT" "DFrI_TH" "DFxE_SLT" "DFxE_TH" "DFyE_SLT" "DFyE_TH" "UVELMASS" "VVELMASS" "WVELMASS")
...
do
  ...
  do
    ...
    # this command intentionally does not push zarr to s3 bucket because here we are creating a zarr store that we will fill with data next
