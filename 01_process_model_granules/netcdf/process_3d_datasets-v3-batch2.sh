...
# Batch 2 to process the following datasets on one EC2
declare -a arr=("KPP_hbl_day_mean" "seaice_flux_day_mean" "tr_adv_x_2D_day_mean" "ocean_vel_day_mean" "tr_adv_r_day_mean" "tr_diff_x_day_mean")
